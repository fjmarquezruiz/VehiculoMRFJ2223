 ...
 */
public class VehiculoMarquezRuizFcoJavier2223 {
    ...
    public VehiculoMarquezRuizFcoJavier2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoMarquezRuizFcoJavier2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
